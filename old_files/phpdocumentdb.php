 ...
 */
 ...
 function HandleHeaderLine( $curl, $header_line ) {
  //  if substr$header_line x-ms-continuation
   if ( substr_compare ( $header_line,'x-ms-continuation' , 0,   14 ) == 0 ) {
     
     echo "new header! " . $header_line;
     $GLOBALS['next_request_header']  = $header_line;
...
curl_setopt($curl, CURLOPT_HEADERFUNCTION, "HandleHeaderLine");
    ...
    ///LAWD JESUS THIS DID IT YO SAFE AND EVERYTHING
  ...
  public function query($rid_id, $rid_col, $query)
  {
    ...
    $headers[] = 'x-ms-max-item-count:50';
      //  $headers[]= 'x-ms-continuation:RID:iuZfANK9VQAzAAAAAAAAAA==#RT:1'; 
    
    if( isset($GLOBALS['next_request_header'])) {
      echo "doing it\n";
    $headers[] = $GLOBALS['next_request_header'];
    // echo  $GLOBALS['next_request_header'];
    echo "HEADERS\n\n";
    print_r($headers);
    }
